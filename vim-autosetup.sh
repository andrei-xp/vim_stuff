...
function install_bundles() {
    ...
    git clone git@github.com:enricobacis/vim-airline-clock.git      ~/.vim/bundle/vim-airline-clock
    git clone git@github.com:tpope/vim-commentary.git               ~/.vim/bundle/vim-commentary.git
    git clone git@github.com:thaerkh/vim-indentguides.git           ~/.vim/bundle/vim-indentguides.git
    ...
    git clone git@github.com:reedes/vim-colors-pencil.git           ~/.vim/bundle/vim-colors-pencil
}
